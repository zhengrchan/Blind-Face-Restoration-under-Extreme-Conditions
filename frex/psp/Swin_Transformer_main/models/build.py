...
from .swin_transformer_yzy import SwinTransformer_yzy
from .swin_transformer_yzy_return import SwinTransformer_yzy_return
...
def build_model(config, is_pretrain=False):
    ...
    elif model_type == 'swin_yzy':
        model = SwinTransformer_yzy(img_size=config.DATA.IMG_SIZE,
                                  patch_size=config.MODEL.SWINV2.PATCH_SIZE,
                                  in_chans=config.MODEL.SWINV2.IN_CHANS,
                                  num_classes=config.MODEL.NUM_CLASSES,
                                  embed_dim=config.MODEL.SWINV2.EMBED_DIM,
    ...
    elif model_type == 'swin_yzy_return':
        model = SwinTransformer_yzy_return(img_size=config.DATA.IMG_SIZE,
                                  patch_size=config.MODEL.SWINV2.PATCH_SIZE,
                                  in_chans=config.MODEL.SWINV2.IN_CHANS,
                                  num_classes=config.MODEL.NUM_CLASSES,
                                  embed_dim=config.MODEL.SWINV2.EMBED_DIM,
